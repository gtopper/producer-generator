...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val containerAlias = ContainerAlias(sys.props.getOrElse("container-alias", "bigdata"))
    val kvOps = KeyValueOperations(containerAlias, sys.props.filterKeys(_.startsWith("v3io")).toMap)

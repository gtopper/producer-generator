...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val lineSource = Source.fromIterator(() => io.Source.stdin.getLines())
    val requestSource = lineSource.mapAsyncUnordered(computeParallelism)(line => Future {
    ...
    val responseSource = requestSource.zipWithIndex.via(httpFlow)
